...
<body id="myPage" data-spy="scroll" data-target=".navbar" data-offset="60">
          ...
          <div class="col-md-12">
            ...
            <div class="collapse navbar-collapse navbar-right" id="myNavbar" >
              <ul class="nav navbar-nav">
                ...
                <li class=""><a href="#service">About Us</a></li>
        ...
        <div class="row">
          <div class="banner-info">
            ...
            <div class="banner-text text-center">
              <h1 class="white">Making Lives Better</h1>
              <p>Your trusted medical record </p>
              <h1><a href="signup.jsp" class="btn btn-appoint">Register / Sign In Now</a></h1>
            </div>
  ...
  <!--/ banner-->
  <!--service-->
 <section id="service" class="section-padding1">
    <div class="container">
      <div class="row">
